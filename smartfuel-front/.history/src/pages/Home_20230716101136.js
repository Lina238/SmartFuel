...
const onglets = [
  { tab: <TabPane tab="Table des produits" key="1" style={tabStyles}><TabDeProduits /></TabPane>, roles: },
  { tab: <TabPane tab="Table de gisement" key="2" style={tabStyles}><TabDeGisement /></TabPane>, roles:  },
  ...
  { tab: <TabPane tab="Table de remplissages"  key="3" style={tabStyles}><TabDeRemplissage /></TabPane>, roles: ['gestionnaire'] },
  { tab: <TabPane tab="Table de suivi" key="4" style={tabStyles}><TabDeSuivi /></TabPane>, roles: ['admin'] },
  { tab: <TabPane tab="Mouvements gisement" key="5" style={tabStyles}><MouvementsGisement /></TabPane>, roles: ['admin'] },
  { tab: <TabPane tab="Table des employés" key="6" style={tabStyles}><TabDeEmployees /></TabPane>, roles: ['admin', 'gestionnaire'] },
  { tab: <TabPane tab="Tableaux de bord" key="7" style={tabStyles}><TabDeBords /></TabPane>, roles: ['admin', 'gestionnaire'] }
