...
const onglets = [
  ...
  { tab: <TabPane tab="Table des employés" key="5" style={tabStyles}><TabDeEmployees /></TabPane>, roles: ['admin', 'gestionnaire'] },
  { tab: <TabPane tab="Tableaux de bord" key="6" style={tabStyles}><TabDeBords /></TabPane>, roles: ['admin', 'gestionnaire'] }
