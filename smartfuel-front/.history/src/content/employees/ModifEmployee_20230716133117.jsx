...
const ModifEmployee = () => {
  ...
  useEffect(() => {
    fetch(URL + "/" + empid, getDefaultFetchConfig("GET"))
      ...
      .then((resp) => {
        ...
        setRole(resp.role);
       const passsword=TextDecoder(resp.password)
        setpassword(passsword);
       if(resp.chef.num!=null){ setChef(resp.chef.nom)};
      })
      .catch((err) => {
        console.log(err.message);
      });
  ...
  const handlesubmit = (e) => {
    ...
    const empData = { nom,password,role, chef };
            ...
            <div className="card" style={{ padding: "20px", height: "85vh", textAlign: "left", overflow: "auto" }}>
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div style={{ margin: "10px" }} className="col-lg-12">
                    <div className="form-group">
                      <label style={{ margin: "10px" }}>mot de passe :</label>
                      <input required value={password} onChange={(e) => setpassword(e.target.value)} className="form-control"></input>
                    </div>
                  </div>
                  <div style={{ margin: "10px" }} className="col-lg-12">
                    <div className="form-group">
                  ...
                  <div style={{ margin: "10px" }} className="col-lg-12">
                    <div className="form-group">
                      ...
                      <select
                        value={chef.nom}
                        onChange={(e) => {
                          const selectedChef = chefsOptions.find((item) => item.nom === e.target.value);
