...
const AjoutSuivi = () => {
  ...
  const handlesubmit = (e) => {
    ...
    const suivData = {
     prix_dachat,unite_de_mesure,quantite,
            ...
            <div className="card" style={{ padding: '20px', height: '85vh', textAlign: 'left', overflow: 'auto' }}>
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div style={{ margin: '10px' }} className="col-lg-12">
                    <div className="form-group">
                      <label style={{ margin: '10px' }}>Quantité achetée :</label>
                  ...
                  <div className="col-lg-12">
                    <div className="form-group">
                      ...
                      <Link to="/Home?tab=remplissages" className="btn btn-danger" style={{ padding: '10px 20px', margin: '20px' }}>
                        Annuler
                      </Link>
                    </div>
                  </div>
