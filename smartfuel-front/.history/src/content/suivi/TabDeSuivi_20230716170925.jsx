...
const TabDeSuivi = () => {
  ...
  useEffect(() => {
    ...
    // Fetch data for the distributor names (Assuming the URL is correct)
    fetch('http://localhost:8080/api/v1/chefs', getDefaultFetchConfig('GET'))
      .then((res) => res.json())
      .then((resp) => {
        // Build the data mapping object
        const mapping = {};
