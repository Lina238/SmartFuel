...
const ModifEmployee = () => {
  ...
  const [selectedChefId, setSelectedChefId] = useState(""); // Nouvel état pour conserver l'ID du chef sélectionné
  ...
  useEffect(() => {
    fetch(URL + "/" + empid, getDefaultFetchConfig("GET"))
      ...
      .then((resp) => {
        ...
        setChef(resp.chef || null);
        setSelectedChefId(resp.chef ? resp.chef.id : ""); // Met à jour l'ID du chef sélectionné
      })
      .catch((err) => {
        console.log(err.message);
      });
                ...
                <div className="row">
                  ...
                  <div style={{ margin: "10px" }} className="col-lg-12">
                    <div className="form-group">
                      ...
                      <select
                        value={selectedChefId} // Utilise l'ID du chef sélectionné
                        onChange={(e) => setSelectedChefId(e.target.value)} // Met à jour l'ID du chef sélectionné
                        className="form-control"
                      >
