...
const URL = "http://localhost:8080/api/v1/admin/Type_gisement" ;
  ...
  return (
    ...
    <tbody  >
          ...
          {  data && data.map(
           ...
           <td >  {item.gisement.nom} </td>
           <td >  {item.gisement.capacite_totale} </td>
           <td >  {item.gisement.seuil} </td>
           <td >  {item.gisement.quantite_actuelle} </td>
