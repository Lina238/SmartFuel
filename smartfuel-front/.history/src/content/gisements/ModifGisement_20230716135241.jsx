...
const ModifEmployee = () => {
  ...
  const handlesubmit = (e) => {
    e.preventDefault();
    if (!chef) { // Vérifie si le chef est null
      alert("Veuillez sélectionner un chef.");
      return;
    }

    const empData = { username, password, role, chef };
                ...
                <div className="row">
                  ...
                  <div style={{ margin: "10px" }} className="col-lg-12">
                    <div className="form-group">
                      ...
                      <select
                        value={chef ? chef.nom : ""} // Utilise chef.nom comme value
                        onChange={(e) => {
                          const selectedChefName = e.target.value;
                          const selectedChef = chefsOptions.find((item) => item.nom === selectedChefName);
                          setChef(selectedChef || null); // Utilise null si aucun chef n'est sélectionné
                        }}
                        className="form-control"
                      >
