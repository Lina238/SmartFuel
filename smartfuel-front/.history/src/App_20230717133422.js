      ...
      <>
       <Router>
             <Routes>
                 ...
                 <Route exact path='/AjouterGisement'  element={<ProtectedRoute element={<AjouterGisement/>}></ProtectedRoute>} />
                 <Route exact path='/ModifierGisement/:gisid'  element={<ProtectedRoute element={<Home/>}></ProtectedRoute>} />
                 <Route exact path='/Home'  element={<ProtectedRoute element={<Home/>}></ProtectedRoute>} />
                 <Route exact path='/Home'  element={<ProtectedRoute element={<Home/>}></ProtectedRoute>} />
                 <Route exact path='/Home'  element={<ProtectedRoute element={<Home/>}></ProtectedRoute>} />
