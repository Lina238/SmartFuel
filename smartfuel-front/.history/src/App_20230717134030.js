      ...
      <>
       <Router>
             <Routes>
                 ...
                 <Route exact path='/AjouterSuivi'  element={<ProtectedRoute element={ModifGisement}></ProtectedRoute>} />
                 <Route exact path='/ModifierSuivi/:suivid'  element={<ProtectedRoute element={ModifGisement}></ProtectedRoute>} />
