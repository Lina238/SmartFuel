      ...
      <>
       <Router>
             <Routes>
                 ...
                 <Route exact path='/AjouterSuivi'  element={<ProtectedRoute element={AjoutSuivi}></ProtectedRoute>} />
                 <Route exact path='/ModifierSuivi/:suivid'  element={<ProtectedRoute element={ModifSuivi}></ProtectedRoute>} />
                 <Route exact path='/AjouterEmployee'  element={<ProtectedRoute element={AjoutEmployee}></ProtectedRoute>} />
                 <Route exact path='/ModifierEmployee/:empid'  element={<ProtectedRoute element={ModifEmployee}></ProtectedRoute>} />
